    ...
    return (
        <>
            ...
            <div>
                ...
                {battle.fighterOne.username == user.username ? <img style={{ width: "75%", position: "absolute", left: "95px", top: "550px"}} alt="img" src={childData.length > 0 ? childData.slice(-1)[0].image : null} /> : null}
            ...
            <div>
                ...
                {battle.fighterTwo.username == user.username ? <img style={{ width: "75%", position: "absolute", left: "300px", top: "550px"}} alt="img" src={childData.length > 0 ? childData.slice(-1)[0].image : null} /> : null}
